...
class robotKinematics:
    def __init__(self):
        ...
        self.coxa = 0.04#coxa length  (L1)
        self.femur = 0.10#femur length  (L2)
        self.tibia = 0.10#tibia length  (L3)
        """initial foot position"""
        #foot separation (0.182 -> tetta=0) and distance to floor
        #### Orientaion that you need to keep the Quadraped is given in the report ####
        self.Ydist = 0.11   # width between the legs 
        self.Xdist = self.L # length between the legs 
        self.height = 0.15  # height of the robot from ground 
